...
public class CitesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mShowAddressBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(CitesActivity.this
    ...
    private void initHousNumbersSpinner() {
        ...
        ArrayAdapter<Integer> adapter = new ArrayAdapter<Integer>(CitesActivity.this, android.R.layout.simple_spinner_item, houseNumbers);
        mHouseNumberSpinner.setAdapter(adapter);
    }

    private void initSpinnerCountries() {
        ArrayAdapter<CharSequence> adapterCountries = ArrayAdapter.createFromResource(CitesActivity.this, R.array.countries, android.R.layout.simple_spinner_item);
    ...
    private void initSpinnerCities(String country) {
        ...
        switch (country) {
            case "Россия":
                adapter = ArrayAdapter.createFromResource(CitesActivity.this, R.array.r_cities, android.R.layout.simple_spinner_item);
                break;
            case "Украина":
                adapter = ArrayAdapter.createFromResource(CitesActivity.this, R.array.u_cities, android.R.layout.simple_spinner_item);
                break;
            case "Белоруссия":
                adapter = ArrayAdapter.createFromResource(CitesActivity.this, R.array.b_cities, android.R.layout.simple_spinner_item);
                break;
        }
        if (adapter != null) {
